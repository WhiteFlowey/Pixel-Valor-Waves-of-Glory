...
func _ready():
	...
	meat_collected.connect(func(value: int): GameManage.meat_counter +=1)

func _process(delta: float) -> void:
	GameManage.player_position = position
	
	#ler input
	read_input()
	
	#processar temporizadaor de ataque
...
func update_attack_cooldown(delta: float) -> void:
	#Atualizar o temporizador de ataque
	if is_attacking:
